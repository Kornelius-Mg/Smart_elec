...
from .views import TransfertList, TransfertDeleteView, TransfertUpdateView, CreateTransfert, TransfertsCompteurList
urlpatterns = [
    ...
    url(r'compteur/(?P<pk>[0-9]+)/$', TransfertsCompteurList.as_view(), name="transferts-compteur"),
]